...
SELECT nombre AS "nombre_de_producto", precio AS euros, precio * 1.14 AS dolares FROM producto;
...
SELECT producto.nombre AS producto_nombre, precio, fabricante.nombre AS fabricante_nombre FROM producto INNER JOIN fabricante ON producto.codigo_fabricante = fabricante.codigo 
...
SELECT producto.nombre AS producto_nombre, precio, fabricante.nombre AS fabricante_nombre FROM producto INNER JOIN fabricante ON producto.codigo_fabricante = fabricante.codigo ORDER BY fabricante.nombre
...
SELECT producto.codigo, producto.nombre AS producto_nombre, fabricante.codigo, fabricante.nombre AS fabricante_nombre FROM producto INNER JOIN fabricante ON producto.codigo_fabricante = fabricante.codigo 

--24 Devuelve el nombre del producto, su precio y el nombre de su fabricante, del producto más barato.
SELECT producto.nombre AS producto_nombre, precio, fabricante.nombre AS fabricante_nombre FROM producto INNER JOIN fabricante ON producto.codigo_fabricante = fabricante.codigo ORDER BY producto.precio LIMIT 1

--25 Devuelve el nombre del producto, su precio y el nombre de su fabricante, del producto más caro.

SELECT producto.nombre AS producto_nombre, precio, fabricante.nombre AS fabricante_nombre FROM producto INNER JOIN fabricante ON producto.codigo_fabricante = fabricante.codigo ORDER BY producto.precio DESC LIMIT 1

--26 Devuelve una lista de todos los productos del fabricante Lenovo.
SELECT producto.nombre AS producto_nombre FROM producto INNER JOIN fabricante ON producto.codigo_fabricante = fabricante.codigo WHERE fabricante.nombre = "Lenovo"

--27 Devuelve una lista de todos los productos del fabricante Crucial que tengan un precio mayor que 200€.

SELECT producto.nombre AS producto_nombre, precio FROM producto INNER JOIN fabricante ON producto.codigo_fabricante = fabricante.codigo WHERE fabricante.nombre = "Lenovo" AND  precio > 200
...
SELECT producto.nombre AS producto_nombre, fabricante.nombre AS fabricante_nombre FROM producto INNER JOIN fabricante ON producto.codigo_fabricante = fabricante.codigo WHERE fabricante.nombre = "Hewlett-Packard" OR fabricante.nombre = "Asus" OR fabricante.nombre = "Seagate"
...
SELECT producto.nombre AS producto_nombre, fabricante.nombre AS fabricante_nombre FROM producto INNER JOIN fabricante ON producto.codigo_fabricante = fabricante.codigo WHERE fabricante.nombre IN ("Hewlett-Packard", "Asus", "Seagate")
...
SELECT producto.nombre AS producto_nombre, precio, fabricante.nombre AS fabricante_nombre FROM producto INNER JOIN fabricante ON producto.codigo_fabricante = fabricante.codigo WHERE fabricante.nombre LIKE "%e"
...
SELECT producto.nombre AS producto_nombre, precio, fabricante.nombre AS fabricante_nombre FROM producto INNER JOIN fabricante ON producto.codigo_fabricante = fabricante.codigo WHERE fabricante.nombre LIKE "%w%"
...
SELECT producto.nombre AS producto_nombre, fabricante.nombre AS fabricante_nombre, precio FROM producto INNER JOIN fabricante ON producto.codigo_fabricante = fabricante.codigo WHERE precio >= 180 ORDER BY precio DESC, producto.nombre  
...
SELECT 	DISTINCT f.codigo, f.nombre AS fabricante_nombre FROM producto p INNER JOIN fabricante f ON p.codigo_fabricante = f.codigo 
...
SELECT p.nombre AS producto_nombre, f.nombre AS fabricante_nombre FROM fabricante f LEFT JOIN producto p ON p.codigo_fabricante = f.codigo 
...
SELECT p.nombre AS producto_nombre, f.nombre FROM fabricante f LEFT JOIN producto p ON p.codigo_fabricante = f.codigo WHERE f.nombre = "Lenovo" 
...
SELECT * FROM producto p, fabricante f WHERE p.codigo_fabricante = f.codigo AND precio =  (SELECT MAX(precio) FROM producto WHERE codigo_fabricante = 2)

--38 Lista el nombre del producto más caro del fabricante Lenovo. 

SELECT p.nombre AS producto_nombre FROM fabricante f LEFT JOIN producto p ON p.codigo_fabricante = f.codigo WHERE f.nombre = "Lenovo" ORDER BY precio LIMIT 1

--39 Lista el nombre del producto más barato del fabricante Hewlett-Packard.

SELECT p.nombre AS producto_nombre FROM fabricante f LEFT JOIN producto p ON p.codigo_fabricante = f.codigo WHERE f.nombre = "Hewlett-Packard" ORDER BY precio DESC LIMIT 1
...
SELECT p.nombre AS producto_nombre, precio FROM fabricante f LEFT JOIN producto p ON p.codigo_fabricante = f.codigo WHERE precio >=  (SELECT MAX(precio) FROM producto, fabricante f WHERE f.nombre = "Lenovo")

--41 Lista todos los productos del fabricante Asus que tienen un precio superior al precio medio de todos sus productos.

SELECT p.nombre AS producto_nombre, precio FROM fabricante f LEFT JOIN producto p ON p.codigo_fabricante = f.codigo WHERE f.nombre = "Asus" AND precio >= (SELECT AVG(precio) FROM producto WHERE codigo_fabricante = 1)
